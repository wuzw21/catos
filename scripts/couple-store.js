...
function publicCapture(capture) {
  return {
    ...
    sourceItemType: capture.sourceItemType || "",
...
function addCapture(userId, payload) {
  return mutateStore((store) => {
    ...
    const capture = {
      ...
      sourceCardId: sanitizeText(payload.sourceCardId, 100),
      sourceTitle: sanitizeText(payload.sourceTitle, 180),
      sourceItemType: sanitizeText(payload.sourceItemType, 40),
      plannedAt: sanitizeText(payload.plannedAt, 40),
      dueAt: sanitizeText(payload.dueAt, 40),
      segment: normalizeSegment(payload.segment),
      timeLabel: sanitizeText(payload.timeLabel, 40),
      assets,
      createdBy: userId,
      createdAt: nowIso(),
    };
